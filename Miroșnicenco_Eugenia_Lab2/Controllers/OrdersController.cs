...
namespace Miroșnicenco_Eugenia_Lab2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(Miroșnicenco_Eugenia_Lab2Context context)
        {
            _context = context;
        }
        ...
        {
            var miroșnicenco_Eugenia_Lab2Context = _context.Order.Include(o => o.Book).Include(o => o.Customer);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Miroșnicenco_Eugenia_Lab2Context.Order'  is null.");
            }
            var order = await _context.Order.FindAsync(id);
            if (order != null)
            {
