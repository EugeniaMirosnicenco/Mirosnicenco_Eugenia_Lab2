...
namespace Miroșnicenco_Eugenia_Lab2.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public AuthorsController(Miroșnicenco_Eugenia_Lab2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Author != null ? 
                          ...
                          Problem("Entity set 'Miroșnicenco_Eugenia_Lab2Context.Author'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Miroșnicenco_Eugenia_Lab2Context.Author'  is null.");
            }
            var author = await _context.Author.FindAsync(id);
            if (author != null)
            {
